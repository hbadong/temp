                            ...
                            xhr.addEventListener('load', function (e) {
                                try{
                                    ...
                                    if(data.error) {
                                        ...
                                        Base.callback(me.editor, me.dialog, data.path, data.state);
                                        setTimeout(function(){ eachUp(i+1); }, 50);
