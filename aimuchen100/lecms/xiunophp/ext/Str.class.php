...
class Str{
    ...
    +----------------------------------------------------------
     */
    static public function msubstr($str = '', $start = 0, $length = 10, $charset = "utf-8", $suffix = true)
    {
    ...
    +----------------------------------------------------------
     */
    static public function build_count_rand ($number = 1, $length = 4, $mode = 1) {
    ...
    +----------------------------------------------------------
     */
    static public function build_format_rand($number = 1, $format = '*')
    {
        $str  =  array();
