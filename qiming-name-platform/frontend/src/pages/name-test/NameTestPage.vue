    ...
    <div id="page-content">
      <div class="qiming-pages-vip">
        <div class="qiming_portal_block_summary">
          <div class="formGsQm">
            <h1>姓名测试打分</h1>
            <p>姓名测试打分通过姓名学五格数理，并且结合周易五行相生相克的理念，根据五格数理吉凶及相生相克情况，最后得出您的姓名评分测试打分。</p>
            <form method="post">
              <div class="two_bd">
                <div class="list_bd">
                  <input
        ...
        <section class="qiming-container qiming-margin-medium-bottom qiming-margin-top-20">
          <div class="qiming-background-default qiming-xmcs qiming-padding-app qiming-margin-medium-bottom">
            <h2 class="apply">
              大数据分析
            </h2>
            <blockquote>
              ...
              <span>男女使用比例</span>
              <span>单字使用性别排名</span>
              <p>基于全网亿万姓名大数据分析，通过全网独家智能测名系统、大数据流行度分析系统，分析名字的使用频率与流行度趋势。多维度名字解析系统，让名字数据可视化，为用户提供更专业、更科学、更可靠的分析结果。</p>
            </blockquote>
            <h2 class="apply">
              音形义详解
            </h2>
            <blockquote>
              ...
              <span>音律搭配</span>
              <span>字义解析</span>
              <p>基于字形、字义、音律一大分析系统，解析名字的意蕴内涵，名字的结构搭配，名字的音律组合，全面剖析名字综合属性、名与姓的搭配、名字来源，让名字指引未来的人生方向。</p>
            </blockquote>
            <h2 class="apply">
              星座分析
            </h2>
            <blockquote>
              ...
              <span>性格标签</span>
              <span>匹配指数</span>
              <p>基于星座特质、星座性格优缺点，分析名字与星座性格的匹配度，通过名字的暗示寓意与星座性格标签解析，分析名字能否补足星座性格缺陷。</p>
            </blockquote>
            <h2 class="apply">
              生肖分析
            </h2>
            <blockquote>
              ...
              <span>生肖特质</span>
              <span>匹配指数</span>
              <p>以传统生肖姓名学理论为依据，根据生肖解析，生肖特质，生肖性格标签，解析名字与名主生肖属性的匹配度，从属相方面提升个人运气。</p>
            </blockquote>
            <h2 class="apply">
              姓名学分析
            </h2>
            <blockquote>
              ...
              <span>姓名学配置</span>
              <span>心理学解密</span>
              <p>根据《数理学》的"象"、"数"理论，将人的姓名来解析名字，分析名字对名主人生多个方面的运程影响，知名方能知命。</p>
            </blockquote>
          </div>
        </section>
      </div>
            ...
            <div class="qiming-pages-web-qa-box-each">
              ...
              <div class="qiming-pages-web-qa-box-each-detail">
                <ul class="qa-box-each-detail-con">
                  <li>测名打分基于姓名学理论，通过AI智能分析系统，大数据流行度分析系统，名字使用的频率与流行趋势，多维度名字解析系统，让名字可视化，为您提供专业，科学，可靠的分析结果。</li>
                </ul>
              </div>
            </div>
            <div class="qiming-pages-web-qa-box-each">
              ...
              <div class="qiming-pages-web-qa-box-each-detail">
                <ul class="qa-box-each-detail-con">
                  <li>测名打分能根据五行数理、寓意解析、音韵评分、心理暗示、汉字潮流等多方面，全方位综合评估名字好坏，并解析名字与个人匹配情况，让您知晓自身名字不足之处，及时作出调整。</li>
                </ul>
              </div>
            </div>
            <div class="qiming-pages-web-qa-box-each">
              ...
              <div class="qiming-pages-web-qa-box-each-detail">
                <ul class="qa-box-each-detail-con">
                  <li>测名打分通过个人名字，分析个人的三才配置，五格吉凶分析，命格简批，姓名与性格，基础运，成功运等相关内容，为您提供最精准、最详尽的参考。</li>
                </ul>
              </div>
            </div>
            <div class="qiming-pages-web-qa-box-each">
              ...
              <div class="qiming-pages-web-qa-box-each-detail">
                <ul class="qa-box-each-detail-con">
                  <li>基于大数据分析，测名打分会综合考量每个名字的重复使用情况，为您提供专业有效数据，帮助您避开重名烦恼，保障名字的合理性与独特性。</li>
                </ul>
              </div>
            </div>
          </div>
...
const handleSubmit = () => {
  ...
  router.push({ path: '/xingmingceshi', query: { name: form.name, gender: form.gender } });
};
</script>
